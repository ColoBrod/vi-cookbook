...
const data = [
  ...
  {
    uuid: ProductUuid.Water,
    slug: "water",
    name: "Вода",
    availableUnits: [Unit.G, Unit.ML],
    calories: 0,
    protein: 0,
    fat: 0,
    carbs: 0,
  ...
  {
    uuid: ProductUuid.MozzarellaCheese,
  ...
  {
    uuid: ProductUuid.SunDriedTomatoes,
  ...
  {
    uuid: ProductUuid.CannedRedBeans,
    slug: "canned-red-beans",
  ...
  {
    uuid: ProductUuid.CannedWhiteBeans,
    slug: "canned-white-beans",
  ...
  {
    uuid: ProductUuid.TomatoesPuree,
    slug: "tomatoes-puree",
    name: "Томатное пюре",
    availableUnits: [Unit.G],
    calories: 32,
  ...
  {
    uuid: ProductUuid.CucumberPickle,
    slug: "cucumber-pickle",
    name: "Соленый огурец",
    availableUnits: [Unit.G],
    calories: 12,
    protein: 0.8,
  ...
  {
    uuid: ProductUuid.IcebergLettuce,
  ...
  {
    uuid: ProductUuid.RedBasil,
    slug: "red-basil",
    name: "Красный базилик",
    availableUnits: [Unit.G],
    calories: 23,
    protein: 3.2,
    fat: 0.6,
  ...
  {
    uuid: ProductUuid.Salt,
    slug: "salt",
    name: "Соль",
    availableUnits: [Unit.G, Unit.TSP, Unit.TBSP],
    calories: 0,
    protein: 0,
    fat: 0,
    carbs: 0,
  ...
  {
    uuid: ProductUuid.CayennePepper,
    slug: "cayenne-pepper",
    name: "Красный перец кайенский",
    availableUnits: [Unit.G],
    calories: 318,
    protein: 12,
    fat: 17,
  ...
  {
    uuid: ProductUuid.JerusalemArtichokeSyrup,
    slug: "jerusalem-artichoke-syrup",
  ...
  {
    uuid: ProductUuid.GrapeSugar,
    slug: "grape-sugar",
    name: "Виноградный сахар",
    availableUnits: [Unit.G],
    calories: 400,
    protein: 0,
    fat: 0,
  ...
  {
    uuid: ProductUuid.CorianderGround,
  ...
  for (const product of data) {
    await prisma.product.create({
      data: { 
        ...product,
        availableUnits: {
          create: product.availableUnits.map((unit) => ({ unit })),
        },
      },
